              ...
              {vista === 'semana'
                ? fechasToShow.map((fecha, i) =>
                  salones.map((salon: any) => (
                    <th key={`${formatFecha(fecha)}-${salon.id}`} style={{ padding: '8px 10px', color: 'white', fontSize: '11px', textAlign: 'center' as const, borderLeft: '1px solid rgba(255,255,255,0.2)', minWidth: '120px' }}>
                    ...
                    salones.map((salon: any) => {
                      ...
                      return (
                        <td key={`${formatFecha(fecha)}-${salon.id}-${hora}`}
                          ...
                          style={{ padding: '1px 3px', verticalAlign: 'top' as const, borderLeft: '1px solid #f1f5f9', cursor: 'pointer', height: '18px', minWidth: '120px' }}
